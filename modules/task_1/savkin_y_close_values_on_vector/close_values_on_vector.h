...
#ifndef MODULES_TEST_TASKS_CLOSE_VALUES_ON_VECTOR_H_
#define MODULES_TEST_TASKS_CLOSE_VALUES_ON_VECTOR_H_
...
#endif  // MODULES_TEST_TASKS_CLOSE_VALUES_ON_VECTOR_H_
